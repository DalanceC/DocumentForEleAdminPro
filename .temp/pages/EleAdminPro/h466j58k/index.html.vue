<template><div><h2 id="_6-9-1-快速使用" tabindex="-1"><a class="header-anchor" href="#_6-9-1-快速使用"><span>6.9.1. 快速使用</span></a></h2>
<p>组件名 <code v-pre>ele-color-picker</code> ，<code v-pre>v1.4.0新增</code> 使用方式：</p>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="/images/6-9-1.png" alt=""></p>
...
<h2 id="_6-9-2-属性列表" tabindex="-1"><a class="header-anchor" href="#_6-9-2-属性列表"><span>6.9.2. 属性列表</span></a></h2>
<table>
<thead>
<tr>
...
<td style="text-align:left">可选 'large' / 'default' / 'small'</td>
</tr>
<tr>
<td style="text-align:left">show-alpha</td>
<td style="text-align:left">Boolean</td>
<td style="text-align:left">是否支持透明度选择</td>
<td style="text-align:left">false</td>
</tr>
<tr>
<td style="text-align:left">color-format</td>
<td style="text-align:left">String</td>
<td style="text-align:left">写入 v-model 的颜色的格式</td>
<td style="text-align:left">可选 'hsl' / 'hsv' / 'hex' / 'rgb'</td>
</tr>
<tr>
<td style="text-align:left">popper-class</td>
<td style="text-align:left">String</td>
<td style="text-align:left">自定义下拉框的类名</td>
<td style="text-align:left"></td>
</tr>
<tr>
<td style="text-align:left">predefine</td>
<td style="text-align:left"><code v-pre>Array&lt;string&gt;</code></td>
<td style="text-align:left">预定义颜色</td>
<td style="text-align:left"></td>
</tr>
<tr>
<td style="text-align:left">customClass</td>
<td style="text-align:left">String</td>
<td style="text-align:left">自定义类名 <code v-pre>v1.6.0新增</code></td>
<td style="text-align:left"></td>
</tr>
</tbody>
</table>
<br/>
<h2 id="_6-9-3-事件列表" tabindex="-1"><a class="header-anchor" href="#_6-9-3-事件列表"><span>6.9.3. 事件列表</span></a></h2>
<table>
<thead>
<tr>
...
<td style="text-align:left">当绑定值变化时触发</td>
<td style="text-align:left">当前值</td>
</tr>
<tr>
<td style="text-align:left">active-change</td>
<td style="text-align:left">面板中当前显示的颜色发生改变时触发</td>
<td style="text-align:left">当前显示的颜色值</td>
</tr>
<tr>
