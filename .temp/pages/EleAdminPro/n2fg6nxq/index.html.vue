<template><div><h2 id="_6-27-1-快速使用" tabindex="-1"><a class="header-anchor" href="#_6-27-1-快速使用"><span>6.27.1. 快速使用</span></a></h2>
<p>仪表盘组件名称 <code v-pre>ele-dashboard</code> ，<code v-pre>v1.11.0新增</code>，使用示例：</p>
...
<h2 id="_6-27-2-属性列表" tabindex="-1"><a class="header-anchor" href="#_6-27-2-属性列表"><span>6.27.2. 属性列表</span></a></h2>
<table>
<thead>
<tr>
...
<td style="text-align:left">'primary','success','warning','danger'</td>
</tr>
<tr>
<td style="text-align:left">color</td>
<td style="text-align:left">自定义颜色</td>
<td style="text-align:left">String</td>
...
<br/>
<h2 id="_6-27-3-插槽列表" tabindex="-1"><a class="header-anchor" href="#_6-27-3-插槽列表"><span>6.27.3. 插槽列表</span></a></h2>
<table>
<thead>
<tr>
...
<td style="text-align:left">默认插槽</td>
<td style="text-align:left"></td>
</tr>
</tbody>
</table>
